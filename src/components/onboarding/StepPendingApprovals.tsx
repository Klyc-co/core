    ...
    <div className="min-h-[80vh] flex flex-col items-center justify-center px-4 py-8">
      <div className="w-full max-w-4xl animate-fade-in">
        ...
        <div className="grid gap-5 sm:grid-cols-3 mb-10">
          {(posts.length > 0 ? posts : defaultPosts).map((post: any, idx: number) => (
            <div
              key={post.id || idx}
              ...
              <div className="p-5 flex flex-col flex-1">
                ...
                <div className="flex gap-1.5 mb-4">
                  {(post.platforms || []).map((p: string) => {
                    ...
                    return (
                      <div key={p} className="w-7 h-7 rounded-lg bg-secondary flex items-center justify-center" title={p}>
...
const defaultPosts = [
  { id: 1, title: "Brand Story Introduction", description: "Introduce your brand's mission.", platforms: ["LinkedIn", "Instagram"] },
  { id: 2, title: "Product Spotlight", description: "Highlight your key offering.", platforms: ["Instagram", "Facebook"] },
  { id: 3, title: "Industry Insight", description: "Share a thought leadership insight.", platforms: ["LinkedIn", "YouTube"] },
];
