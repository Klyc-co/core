  ...
  return (
    <section className="py-24 sm:py-32 lg:py-40 px-4 sm:px-6 bg-background">
      <div className="max-w-5xl mx-auto">
        <AnimateOnScroll>
          <h2 className="text-3xl sm:text-4xl md:text-5xl lg:text-6xl font-bold text-foreground tracking-tight leading-tight mb-4">
            Stop Hiring Output.
            <br />
            <span className="text-muted-foreground">Start Building Infrastructure.</span>
          </h2>
        </AnimateOnScroll>
        ...
        <div className="grid md:grid-cols-3 gap-px bg-border rounded-xl overflow-hidden">
          {layers.map((layer, i) => (
            <AnimateOnScroll key={i} delay={150 + i * 100}>
              <div className="bg-background p-8 sm:p-10 h-full flex flex-col">
