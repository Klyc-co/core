  ...
  return (
    <Card className="border-border/60 bg-card/80 backdrop-blur-sm">
      ...
      <CardContent className="space-y-3">
        {/* Campaign Brief */}
        <SignalBox icon={<FileText className="w-3.5 h-3.5 text-primary" />} label="Campaign Brief">
          <Textarea
        ...
        {/* Row: Geo / Industry / Customer Size */}
        <div className="grid grid-cols-1 sm:grid-cols-3 gap-3">
          <SignalBox icon={<Globe className="w-3.5 h-3.5 text-primary" />} label="Geography">
          ...
          <SignalBox icon={<Building2 className="w-3.5 h-3.5 text-primary" />} label="Industry">
          ...
          <SignalBox icon={<Users className="w-3.5 h-3.5 text-primary" />} label="Customer Size">
        ...
        {/* Row: Competitor / Addressable Market */}
        <div className="grid grid-cols-1 sm:grid-cols-2 gap-3">
          <SignalBox icon={<Target className="w-3.5 h-3.5 text-primary" />} label="Competitor">
          ...
          <SignalBox icon={<Crosshair className="w-3.5 h-3.5 text-primary" />} label="Addressable Market">
        ...
        {/* Row: Business Need / Regulatory */}
        <div className="grid grid-cols-1 sm:grid-cols-2 gap-3">
          <SignalBox icon={<Package className="w-3.5 h-3.5 text-primary" />} label="Business Need">
          ...
          <SignalBox icon={<Shield className="w-3.5 h-3.5 text-primary" />} label="Regulatory Driver">
        ...
        {/* Product Definition */}
        <SignalBox icon={<Package className="w-3.5 h-3.5 text-primary" />} label="Product Definition">
          <Textarea
            className="text-sm min-h-[68px] bg-background/60 border-border/50 resize-none"
        ...
        {/* Strategy Mode */}
        <SignalBox icon={<Settings2 className="w-3.5 h-3.5 text-primary" />} label="Strategy Mode">
          <ToggleGroup
            type="single"
            value={state.mode}
          ...
          >
            <ToggleGroupItem value="reactive" className="text-xs px-3 data-[state=on]:bg-primary data-[state=on]:text-primary-foreground">Reactive</ToggleGroupItem>
            <ToggleGroupItem value="proactive" className="text-xs px-3 data-[state=on]:bg-primary data-[state=on]:text-primary-foreground">Proactive</ToggleGroupItem>
...
function SignalBox({ icon, label, children }: { icon: React.ReactNode; label: string; children: React.ReactNode }) {
  return (
