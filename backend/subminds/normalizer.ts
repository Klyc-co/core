...
export class NormalizerSubmind extends BaseSubmind {
    ...
    try {
      ...
      const envelope: NormalizationReportEnvelope = {
        runMetadata: {
          ...
          workflowVersion: NormalizerSubmind.WORKFLOW_VERSION,
          status: 'normalized',
        },
  ...
  private classifyRequestType(request: any): RequestType {
    ...
    if (request.submindType || request.agentType) return 'submind_run'
...
export const NormalizerAgent = NormalizerSubmind
