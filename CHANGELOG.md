...
#### Commits to Production Repo (klyc_social_marketing_atscale)
...
- **ai-controller → klyc_social_marketing_atscale merge: COMPLETE**
...
- ~~Repo rename~~ — DONE: renamed to `klyc_social_marketing_atscale` on 2026-03-30
...
1. **`4aae3de`** — `feat: add unified CHANGELOG.md` — Consolidated ai-controller + klyc_social_marketing_atscale history into single production changelog
...
- `[infra]` Backend source of truth moved from `klyc-ai/ai-controller` to `klyc-ai/klyc_social_marketing_atscale`
- `[infra]` ai-controller repo retained as fallback only — all new development targets klyc_social_marketing_atscale
